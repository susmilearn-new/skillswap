        ...
        <>
            <section className="home-banner section-bg py-16 md:py-24">
                <div className='container mx-auto px-4 md:px-8 lg:px-16 text-center wrapper'>
                    ...
                    <h6 className='text-gray-500 text-lg py-8'>Connect with world-class mentors and industry experts. Access curated learning paths designed by AI to accelerate your career growth.</h6>
                    ...
                    <div className='skill-set pt-16'>
                        <h4 className='font-mono text-xs uppercase text-gray-500'>Popular Skills</h4>
                        <ul className='flex flex-wrap align-center justify-center pt-4 gap-4'>
                            {skill.map((skills, index) => {
                                return (
                                    <li key={index} className='border border-gray-300 border-solid py-1 px-4 rounded-full text-sm'>{skills.Skillname}</li>
                                )
                            })}
                        </ul>
                    </div>
